...
const HeroSection = () => {
  ...
  const buttonBaseClasses = "w-full sm:w-[250px] flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white transform transition-all duration-200 hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 md:py-4 md:text-lg md:px-10";
        ...
        <div className="relative z-10 bg-white sm:pb-16 md:pb-20 lg:w-full lg:pb-28 xl:pb-32">
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mx-auto max-w-4xl">
              ...
              <div className="mt-5 sm:mt-8 flex flex-col sm:flex-row justify-center items-stretch space-y-4 sm:space-y-0 sm:space-x-4">
                <div className="rounded-md w-full sm:w-auto">
                  ...
                  >
                    ...
                    <span className="whitespace-nowrap">Заказать тестовой продукции</span>
                  </a>
                </div>
                <div className="rounded-md w-full sm:w-auto">
                  <a
