...
const ContactsPage = () => {
  ...
  const contactInfo = {
    ...
    legal: {
      companyName: t('contacts.legal.companyName'),
      inn: '12345678901234',
      ogrn: '1234567890123',
    },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                <div className="p-6">
                  <h2 className="text-xl font-semibold text-gray-900 mb-4">
                    {t('contacts.legal.title')}
                  </h2>
                  <div className="space-y-2 text-gray-600">
                    <p>{contactInfo.legal.companyName}</p>
                    <p>{t('contacts.legal.inn')}: {contactInfo.legal.inn}</p>
                    <p>{t('contacts.legal.ogrn')}: {contactInfo.legal.ogrn}</p>
                  </div>
                </div>
              </div>
                ...
                <div className="p-6">
                  ...
                  <div className="aspect-w-16 aspect-h-9">
                    <iframe
                      ...
                      title={t('contacts.location.mapTitle')}
                    ></iframe>
                  </div>
                </div>
              </div>
